...
*/
        ...
        // 출력단
        System.out.println("이름 : "+name+"님"); //이름
        System.out.println("국어 : "+kor+"점, 영어 : "+eng+"점, 수학 : "+math+"점"); // 점수
        System.out.printf("총점 : %d점, 평균 : %.5f",(kor+eng+math),((kor+eng+math)/3.0)); // 총점 토탈, 평균
        System.out.println(); // 공백 점프
        System.out.println("학점 : "+grade); // 학점
        System.out.println("메시지 : "+message); // 메시지 출력단
        //
    }
}
